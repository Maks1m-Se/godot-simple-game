...
/** @type {string} */
const CACHE_VERSION = '1739890061|79376854';
/** @type {string} */
const CACHE_PREFIX = 'godot-simple-gam-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'godot-simple-game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["godot-simple-game.html","godot-simple-game.js","godot-simple-game.offline.html","godot-simple-game.icon.png","godot-simple-game.apple-touch-icon.png","godot-simple-game.worker.js","godot-simple-game.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["godot-simple-game.wasm","godot-simple-game.pck"];
